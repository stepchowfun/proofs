...
(* Assumption: Let (T, leq) be a partial order. *)
...
Axiom antiSymm : forall x y, leq x y -> leq y x -> x = y.

(*
  A supremum of a subset of T is the least element of T which is greater than
  or equal to every element in the subset.
*)
...
(* We will need this lemma about pairs of natural numbers. *)

Lemma natDiff :
  forall n1 n2,
  exists n3,
  n1 = add n2 n3 \/ n2 = add n1 n3.
Proof.
  induction n1; intros.
...
(*
  Iterated applications of a monotone function to bottom form an ω-chain.
*)
...
(*
  The set of iterated applications of a monotone function to bottom is
  directed.
*)
